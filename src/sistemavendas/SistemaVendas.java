...
public class SistemaVendas {
    ...
    public static void main(String[] args) {
        ...
        menu.listaFornecedores.add(new Fornecedor("Dell"));
        menu.listaFornecedores.add(new Fornecedor("Samsung"));
        menu.listaFornecedores.add(new Fornecedor("Positivo"));
        menu.listaFornecedores.add(new Fornecedor("AMD"));
        menu.listaFornecedores.add(new Fornecedor("LG"));
        ...
        menu.avaliacoes.add(new TabelaAvaliacoes(menu.listaFornecedores.get(0), 2));
        menu.avaliacoes.add(new TabelaAvaliacoes(menu.listaFornecedores.get(1), 4));
        menu.avaliacoes.add(new TabelaAvaliacoes(menu.listaFornecedores.get(1), 3));
        menu.avaliacoes.add(new TabelaAvaliacoes(menu.listaFornecedores.get(1), 1));
